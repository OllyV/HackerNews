...
3. OutputCaching for get best n endpoint.
4. Retries and CircuitBraker Policy added for hacker-news HttpClient to retry/keep app from calling hacker-news for some time if it returns errors
